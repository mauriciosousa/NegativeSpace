...
public class PerspectiveProjection : MonoBehaviour
{
    ...
    private float nearClipDistanceOffset = -0.01f;

    private Camera cameraComponent;

    private SurfaceRectangle _surface;
    ...
    void LateUpdate ()
    {
        if (_running)
        {
            ...
            pa = _surface.SurfaceBottomRight;
            pb = _surface.SurfaceBottomLeft;
            pc = _surface.SurfaceTopRight;
